...
@section('page-subtitle', auth()->user()->isPrincipal() ? 'Principal account' : 'Administrator account')
...
<div class="row gy-24 justify-content-center">
    ...
    <div class="col-lg-4">
        <div class="card shadow-1 radius-8 p-24 text-center">
            ...
            <p class="text-sm text-secondary-light mb-0">
                ...
                @else IT Administrator
                @endif
            </p>
            <p class="text-sm text-secondary-light">{{ $user->email }}</p>
            ...
            {{-- Signature preview (principal only) --}}
            @if(auth()->user()->isPrincipal() && $user->signature)
            <hr class="my-16">
    ...
    <div class="col-lg-8">
        ...
        {{-- ── Signature Upload (principal only) ── --}}
        ...
        <div class="card shadow-1 radius-8 mb-20">
            ...
            <div class="card-body p-24">
                <p class="text-sm text-secondary-light mb-20">
                    Upload a clear image of your signature. It will appear automatically on generated student result sheets
                    in the <strong>Principal's Signature</strong> section.
                </p>
                <div class="row gy-16 align-items-center">
                    ...
                    <div class="{{ $user->signature ? 'col-sm-7' : 'col-12' }}">
                        <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf @method('PUT')
                            {{-- Carry over required name field --}}
